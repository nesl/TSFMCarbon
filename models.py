...
class ChronosModel:
    ...
    def __init__(self, name, device="cuda"):
        ...
        # or locally
        # pipeline = ChronosPipeline.from_pretrained("/data/kangyang/carbon/TSFM_Building_carbon/chronos-forecasting/scripts/output/run-0/checkpoint-final")
...
class TimeGPTModel:
    ...
    def __init__(self):
        ...
        # 1. for CISO region, used, kyang73@ucmerced.edu
        # self.model = NixtlaClient(api_key="nixak-ENTYotF1LOfjsdEfvFWNCXhz1dwVykbmYYVStJVXt08kiv3Ai0JaZ9uD9BoewFNSL8RDMiizRlfgKl29")

        # 2. for PJM, and ERCO region, using, kyang73@g.ucla.edu
        # self.model = NixtlaClient(api_key="nixak-FhqIWjiJVSPuAqPyS7b6iT5a32BUXTqRygZiNFo9mT1zYKvv2xDifYUK3Nm7UARzo92CT795s4auKcYd")
        
        # 3. for ISNE, and SE region, not used, twang61@ucmerced.edu
        # self.model = NixtlaClient(api_key="nixak-x57Q09tR3t4vZWnqgocO9YyeuY32d2yWFXIK2T9m5Pp7KBIFbTTtGyJPPNVOm08VU6Q4lbWvTzjZeD7P")
        
        # ["BPAT", "FPL", "NYISO", "PL", "ES", "NL", "AUS_QLD"]
        # yuanlin, BPAT, used
        # self.model = NixtlaClient(api_key="nixak-re6OehNKxjqgMG8onG4o0lBgabajRhaXcT6mYd3xk3difXWuuY5sFD9jQ49VRoW0Z94hgmaoyBF1Zv7i")

        # Dip, used
        # self.model = NixtlaClient(api_key="nixak-Z5gjmrVNuzQnFWLbsXUkfEvK1drf3Z98CtJAJDqomAf8HCZ90inTZvxMNpndjrYKl8GFnhPovvvoGUG4")

        #liying used
        # self.model = NixtlaClient(api_key="nixak-H69h66245UJkyvjip3Uc5PXnqEKvM9a7IcpmBRodTpyn59U7YKmgCvQox7mazCDQkliEYbHbC4dxuJiW")

        # yuning, using, ES, used 1861 times then failed
        # try again for ES from strat
        # self.model = NixtlaClient(api_key="nixak-JrXx1jZZ0OJ950BoBGRKARvyqMemSClhfp7IUjuiSOlmU7Ga9q8E1xzvF6nDgbD4i4H6N8MPJgGf6cjv")
        
        # younce, using, now NL
        self.model = NixtlaClient(api_key="nixak-Te8OgmAsEo21PgpxNxVh28gLLazQVggkxXKl6SY64lWtK7oKJexfvEHCtjSW5nLpffwsfrEhXBDYwV82")
...
class TimesFMModel:
    def __init__(self, seq_len, horizen_len, pacth_len, device="cuda"):
        import timesfm
        ...
        #             backend=backend,
        #             per_core_batch_size=pacth_len,
        #             horizon_len=horizen_len,
        #             num_layers=50,
    ...
    def __call__(self, data, freq_level=0, prediction_length=None):
        ...
        return denormalized_forecast[:prediction_length] # (96,)
